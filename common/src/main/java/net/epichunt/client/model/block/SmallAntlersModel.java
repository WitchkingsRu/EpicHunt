...
public class SmallAntlersModel extends SkullModel {
	...
	public SmallAntlersModel(ModelPart root) {
        super(root);
        this.antlers = root.getChild("head");
	}
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition antlers = partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 5).addBox(1.0F, -5.7588F, 0.3681F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
