...
import net.epichunt.entity.animations.WhiteStorkAnimation;
...
public class CommonCraneModel<T extends Entity> extends HierarchicalModel<T> {
	...
	public CommonCraneModel(ModelPart root) {
	...
	public void setupAnim(Entity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		this.animateWalk(WhiteStorkAnimation.walk, limbSwing, limbSwingAmount, 2f, 2.5f);
	}
