...
public class RazorbillModel<T extends Entity> extends HierarchicalModel<T> {
	...
	public RazorbillModel(ModelPart root) {
	...
	public void setupAnim(Entity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		this.animateWalk(RazorbillAnimation.walk, limbSwing, limbSwingAmount, 2f, 2.5f);
	}
