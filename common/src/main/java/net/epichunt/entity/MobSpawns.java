...
public class MobSpawns {
    ...
    public static void spawnsInit(ConfigMain SPAWN_CONFIG) {
        ...
        addEntitySpawns(context -> ((!(context.hasTag(BiomeTags.HAS_IGLOO)) && !(context.hasTag(BiomeTags.SPAWNS_SNOW_FOXES))) && !(context.hasTag(BiomeTags.IS_OCEAN))&& !(context.hasTag(BiomeTags.HAS_VILLAGE_DESERT)) && !(context.hasTag(BiomeTags.IS_BADLANDS)) && (context.hasTag(BiomeTags.IS_OVERWORLD))), MobCategory.AMBIENT, KESTREL_ENTITY::get, CONFIG.kestrel.weight, CONFIG.kestrel.minAmount, CONFIG.kestrel.maxAmount);
        addEntitySpawns(context -> ((!(context.hasTag(BiomeTags.HAS_IGLOO)) && !(context.hasTag(BiomeTags.SPAWNS_SNOW_FOXES))) && !(context.hasTag(BiomeTags.IS_OCEAN))&& !(context.hasTag(BiomeTags.HAS_VILLAGE_DESERT))&& !(context.hasTag(BiomeTags.IS_BADLANDS)) && (context.hasTag(BiomeTags.IS_OVERWORLD))), MobCategory.AMBIENT, EAGLE_ENTITY::get, CONFIG.eagle.weight, CONFIG.eagle.minAmount, CONFIG.eagle.maxAmount);
        addEntitySpawns(context -> ((!(context.hasTag(BiomeTags.HAS_IGLOO)) && !(context.hasTag(BiomeTags.SPAWNS_SNOW_FOXES))) && !(context.hasTag(BiomeTags.IS_OCEAN))&& !(context.hasTag(BiomeTags.HAS_VILLAGE_DESERT)) && !(context.hasTag(BiomeTags.IS_BADLANDS)) && (context.hasTag(BiomeTags.IS_OVERWORLD))), MobCategory.AMBIENT, HAWK_ENTITY::get, CONFIG.hawk.weight, CONFIG.hawk.minAmount, CONFIG.hawk.maxAmount);
        ...
        addEntitySpawns(context -> ((context.hasTag(BiomeTags.HAS_VILLAGE_DESERT)) || (context.hasTag(BiomeTags.IS_BADLANDS))), MobCategory.AMBIENT, EAGLE_ENTITY::get, CONFIG.deagle.weight, CONFIG.deagle.minAmount, CONFIG.deagle.maxAmount);
