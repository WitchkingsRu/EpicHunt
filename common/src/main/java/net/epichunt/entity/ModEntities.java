...
import net.epichunt.entity.client.render.CaribouRender;
import net.epichunt.entity.client.render.DeerRender;
import net.epichunt.entity.client.render.DoeRender;
import net.epichunt.entity.client.render.RoeDeerRender;
