...
public class CaribouEntity extends Animal {

    public CaribouEntity(EntityType<? extends Animal> entityType, Level level) {
        super(entityType, level);
    }
    public static final Supplier<EntityType<CaribouEntity>> CARIBOU = Suppliers.memoize(() -> EntityType.Builder.of(CaribouEntity::new, MobCategory.CREATURE)
            .sized(1f, 2f).build("caribou"));
...
//        this.goalSelector.addGoal(3, new EatBlockGoal(this));;
    ...
    public AgeableMob getBreedOffspring(ServerLevel serverLevel, AgeableMob ageableMob) {
        return CARIBOU.get().create(serverLevel);
    }
