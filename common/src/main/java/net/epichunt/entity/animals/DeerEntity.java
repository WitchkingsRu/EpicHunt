...
public class DeerEntity extends Animal {
    ...
    public static final Supplier<EntityType<DeerEntity>> DEER = Suppliers.memoize(() -> EntityType.Builder.of(DeerEntity::new, MobCategory.CREATURE)
            .sized(1f, 2f).build("deer"));
...
//        this.goalSelector.addGoal(3, new EatBlockGoal(this));;
    ...
    public AgeableMob getBreedOffspring(ServerLevel serverLevel, AgeableMob ageableMob) {
        return DEER.get().create(serverLevel);
    }
