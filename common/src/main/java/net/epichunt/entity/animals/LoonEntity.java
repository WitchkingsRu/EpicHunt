...
public class LoonEntity extends Animal {
    ...
    public LoonEntity(EntityType<? extends Animal> entityType, Level level) {
    ...
    public static boolean checkLoonSpawnRules(EntityType<LoonEntity> type, LevelAccessor levelAccessor, MobSpawnType spawnType, BlockPos pos, RandomSource random) {
    ...
    protected PathNavigation createNavigation(Level arg) {
        return new LoonNavigation(this, arg);
    }
    ...
    private static class LoonNavigation extends AmphibiousPathNavigation {
        LoonNavigation(Mob mob, Level level) {
            super(mob, level);
        }
...
//        }
    ...
    private static class LoonMoveControl extends MoveControl {
        private final LoonEntity duck;

        LoonMoveControl(LoonEntity duck) {
            super(duck);
            this.duck = duck;
        }
    ...
    public AgeableMob getBreedOffspring(ServerLevel serverLevel, AgeableMob ageableMob) {
        return LOON.get().create(serverLevel);
    }
