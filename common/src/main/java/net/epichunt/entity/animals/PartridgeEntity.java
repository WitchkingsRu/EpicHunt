...
public class PartridgeEntity extends Animal {
    ...
    public PartridgeEntity(EntityType<? extends Animal> entityType, Level level) {
    ...
    public AgeableMob getBreedOffspring(ServerLevel serverLevel, AgeableMob ageableMob) {
        return PARTRIDGE.get().create(serverLevel);
    }
