...
public class RoeDeerEntity extends Animal {
    ...
    public static final Supplier<EntityType<RoeDeerEntity>> ROE_DEER = Suppliers.memoize(() -> EntityType.Builder.of(RoeDeerEntity::new, MobCategory.CREATURE)
            .sized(0.8f, 1.2f).build("roe_deer"));
...
//        this.goalSelector.addGoal(3, new EatBlockGoal(this));;
    ...
    public AgeableMob getBreedOffspring(ServerLevel serverLevel, AgeableMob ageableMob) {
        return ROE_DEER.get().create(serverLevel);
    }
