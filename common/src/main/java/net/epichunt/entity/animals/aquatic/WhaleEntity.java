...
public class WhaleEntity extends WaterAnimal {
    ...
    private int spoutCooldown = 1000;
    ...
    protected void registerGoals() {
        this.goalSelector.addGoal(0, new SurfaceSpoutGoal(this));
    ...
    static class SurfaceSpoutGoal extends Goal {
        private final WhaleEntity mob;

        public SurfaceSpoutGoal(WhaleEntity pathfinderMob) {
