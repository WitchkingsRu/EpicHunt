...
public class PerchesEntity extends AbstractSchoolingFish {
    public PerchesEntity(EntityType<? extends PerchesEntity> entityType, Level level) {
    ...
    public ItemStack getBucketItemStack() {
        return new ItemStack(ModItem.PERCHES_BUCKET.get());
    }
