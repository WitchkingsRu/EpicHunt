...
public class SardineEntity extends AbstractSchoolingFish {
    public SardineEntity(EntityType<? extends SardineEntity> entityType, Level level) {
    ...
    public ItemStack getBucketItemStack() {
        return new ItemStack(ModItem.SARDINE_BUCKET.get());
    }
