...
public class OrcaAnimation {
	public static final AnimationDefinition swim = AnimationDefinition.Builder.withLength(2.0F).looping()
		...
		.addAnimation("body3", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			...
			new Keyframe(1.5F, KeyframeAnimations.degreeVec(15.0F, -0.5F, 0.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(2.0F, KeyframeAnimations.degreeVec(0.0F, -0.5F, 0.0F), AnimationChannel.Interpolations.LINEAR)
		))
