...
public class WisentAnimation {
	public static final AnimationDefinition walk = AnimationDefinition.Builder.withLength(1.0F).looping()
		.addAnimation("leg3", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			...
			new Keyframe(1.0F, KeyframeAnimations.degreeVec(-0.0209F, 1.0563F, -2.266F), AnimationChannel.Interpolations.LINEAR)
		))
	...
	public static final AnimationDefinition walk_angry = AnimationDefinition.Builder.withLength(1.0F).looping()
		.addAnimation("leg3", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.25F, KeyframeAnimations.degreeVec(-25.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.5F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
