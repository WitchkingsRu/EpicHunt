...
public class DuckModel<T extends Entity> extends HierarchicalModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		.texOffs(30, 12).addBox(-1.0F, -2.0F, -2.5F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(36, 12).addBox(-0.5F, -1.0F, -4.5F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(36, 12).addBox(-0.499F, -1.5F, -3.5F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -8.0F, -1.0F));
